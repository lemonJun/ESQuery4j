...
public class CompanyIndexTwo {
    ...
    private static final int INDEX_CNT_EVERY_TIME = 500;

    static RateLimiter limit = RateLimiter.create(500.0d);
        ...
        public boolean processLine(String line) throws IOException {
            try {
                if (StringUtil.isNotNullOrEmpty(line)) {
                    ...
                    CompanyEsInfo bean = new CompanyEsInfo();
                    //                    bean.setId(arys[0]);
                    bean.setId(arys[0]);
                    ...
                    bean.setSize(random.nextInt() / 1000);
