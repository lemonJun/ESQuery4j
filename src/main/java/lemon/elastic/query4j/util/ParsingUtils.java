...
public abstract class ParsingUtils {
    ...
    public static String reconcatenateCamelCase(String source, String delimiter) {
        ...
        Preconditions.checkNotNull(source, "Source string must not be null!");
        Preconditions.checkNotNull(delimiter, "Delimiter must not be null!");

        return SpringStringUtils.collectionToDelimitedString(splitCamelCaseToLower(source), delimiter);
    }
