...
public class Version implements Comparable<Version> {
    ...
    public Version(int... parts) {
        ...
        Preconditions.checkState(parts.length > 0 && parts.length < 5);
        ...
        Preconditions.checkState(major >= 0, "Major version must be greater or equal zero!");
        Preconditions.checkState(minor >= 0, "Minor version must be greater or equal zero!");
        Preconditions.checkState(bugfix >= 0, "Bugfix version must be greater or equal zero!");
        Preconditions.checkState(build >= 0, "Build version must be greater or equal zero!");
    }
    ...
    public static Version parse(String version) {
        ...
        Preconditions.checkState(SpringStringUtils.hasText(version));
        ...
        for (int i = 0; i < parts.length; i++) {
            ...
            if (SpringStringUtils.hasText(input)) {
                try {
    ...
    public String toString() {
        ...
        return SpringStringUtils.collectionToDelimitedString(digits, ".");
    }
}
