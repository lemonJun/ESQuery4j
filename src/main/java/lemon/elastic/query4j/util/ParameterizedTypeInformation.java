...
class ParameterizedTypeInformation<T> extends ParentTypeAwareTypeInformation<T> {
     ...
     */
    public ParameterizedTypeInformation(ParameterizedType type, TypeDiscoverer<?> parent, Map<TypeVariable<?>, Type> typeVariableMap) {
    ...
    public String toString() {
        ...
        return String.format("%s<%s>", getType().getName(), SpringStringUtils.collectionToCommaDelimitedString(getTypeArguments()));
    }
