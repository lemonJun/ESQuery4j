 ...
 */
public class Sort implements Iterable<lemon.elastic.query4j.esproxy.domain.Sort.Order>, Serializable {
    ...
    public String toString() {
        return SpringStringUtils.collectionToCommaDelimitedString(orders);
    }
    ...
    public static class Order implements Serializable {
        ...
        private Order(Direction direction, String property, boolean ignoreCase, NullHandling nullHandling) {
            ...
            if (!SpringStringUtils.hasText(property)) {
