 ...
 */
package lemon.elastic.query4j.esproxy.domain;
...
public class Range<T extends Comparable<T>> {
    ...
    public boolean contains(T value) {
        ...
        Preconditions.checkNotNull(value, "Reference value must not be null!");

        boolean greaterThanLowerBound = lowerBound == null ? true : lowerInclusive ? lowerBound.compareTo(value) <= 0 : lowerBound.compareTo(value) < 0;
        boolean lessThanUpperBound = upperBound == null ? true : upperInclusive ? upperBound.compareTo(value) >= 0 : upperBound.compareTo(value) > 0;
