...
//
//import lemon.elastic.query4j.converter.ConversionService;
...
//
//        Preconditions.checkNotNull(accessor, "PersistentPropertyAccessor must not be null!");
...
//        return (T) (source == null ? source : type.isAssignableFrom(source.getClass()) ? source : conversionService.convert(source, type));
//    }
//}
