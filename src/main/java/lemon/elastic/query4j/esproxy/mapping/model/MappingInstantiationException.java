...
public class MappingInstantiationException extends RuntimeException {
    ...
    private static final String buildExceptionMessage(PersistentEntity<?, ?> entity, List<Object> arguments, String defaultMessage) {
        ...
        return String.format(TEXT_TEMPLATE, entity.getType().getName(), constructor == null ? "NO_CONSTRUCTOR" : constructor.getConstructor().toString(), SpringStringUtils.collectionToCommaDelimitedString(arguments));
    }
