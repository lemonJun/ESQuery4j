...
// */
//package lemon.orm.elastic.esproxy.mapping.model;
//
//import com.google.common.base.Preconditions;
//
//import lemon.orm.elastic.converter.ConversionService;
//import lemon.orm.elastic.esproxy.mapping.PersistentProperty;
//import lemon.orm.elastic.esproxy.mapping.PreferredConstructor.Parameter;
//
///**
...
//
//        Preconditions.checkNotNull(evaluator, "SpELExpressionEvaluator must not be null!");
//        Preconditions.checkNotNull(conversionService, "ConversionService must not be null!");
//        Preconditions.checkNotNull(delegate, "ParameterValueProvider delegate must not be null!");
//
