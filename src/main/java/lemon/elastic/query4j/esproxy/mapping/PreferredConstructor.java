...
import lemon.elastic.query4j.util.ObjectUtils;
...
/**
 * Value object to encapsulate the constructor to be used when mapping
...
public class PreferredConstructor<T, P extends PersistentProperty<P>> {
    ...
    /**
     * Creates a new {@link PreferredConstructor} from the given
     * {@link Constructor} and {@link Parameter}s.
     * 
     * @param constructor
    ...
    /**
     * Returns whether the given {@link PersistentProperty} is referenced in a
     * constructor argument of the {@link PersistentEntity} backing this
    ...
    /**
     * Returns whether the given {@link Parameter} is one referring to an
     * enclosing class. That is in case the class this
     * {@link PreferredConstructor} belongs to is a member class actually. If
     * that's the case the compiler creates a first constructor argument of the
    ...
    public static class Parameter<T, P extends PersistentProperty<P>> {
        ...
        /**
         * Creates a new {@link Parameter} with the given name,
         * {@link TypeInformation} as well as an array of {@link Annotation}s.
         * Will insprect the annotations for an {@link Value} annotation to
         * lookup a key or an SpEL expression to be evaluated.
         * 
         * @param name
         *        the name of the parameter, can be {@literal null}
         * @param type
         *        must not be {@literal null}
         * @param annotations
         *        must not be {@literal null} but can be empty
         * @param entity
         *        can be {@literal null}.
         */
        ...
        /**
         * Returns the name of the parameter or {@literal null} if none was
         * given.
         * 
         * @return
         */
        ...
        /**
         * Returns the key to be used when looking up a source data structure to
         * populate the actual parameter value.
         * 
         * @return
         */
        ...
        /**
         * Returns whether the constructor parameter is equipped with a SpEL
         * expression.
         * 
         * @return
         */
        public boolean hasSpelExpression() {
            ...
            if (this.hasSpelExpression == null) {
                this.hasSpelExpression = SpringStringUtils.hasText(getSpelExpression());
            }
