...
public interface MappingContext<E extends PersistentEntity<?, P>, P extends PersistentProperty<P>> {
     ...
     * 
     * @see lemon.elastic.query4j.esproxy.mapping.model.SimpleTypeHolder#isSimpleType(Class)
     ...
     *         {@link lemon.elastic.query4j.esproxy.mapping.model.SimpleTypeHolder#isSimpleType(Class)}).
     */
