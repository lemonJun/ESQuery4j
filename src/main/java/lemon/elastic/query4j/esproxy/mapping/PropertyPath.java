...
public class PropertyPath implements Iterable<PropertyPath> {
    ...
    PropertyPath(String name, TypeInformation<?> owningType, List<PropertyPath> base) {
        ...
        Preconditions.checkState(SpringStringUtils.hasText(name), "Name must not be null or empty!");
        Preconditions.checkNotNull(owningType, "Owning type must not be null!");
        Preconditions.checkNotNull(base, "Perviously found properties must not be null!");

        String propertyName = name.matches(ALL_UPPERCASE) ? name : SpringStringUtils.uncapitalize(name);
    ...
    public static PropertyPath from(String source, TypeInformation<?> type) {
        ...
        Preconditions.checkState(SpringStringUtils.hasText(source), "Source must not be null or empty!");
        Preconditions.checkNotNull(type, "TypeInformation must not be null or empty!");
    ...
    private static PropertyPath create(String source, TypeInformation<?> type, String addTail, List<PropertyPath> base) {
        ...
        try {
            ...
            if (SpringStringUtils.hasText(addTail)) {
