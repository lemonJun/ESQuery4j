...
//import lemon.elastic.query4j.exceptions.InvalidDataAccessApiUsageException;
...
// * criteria.
// * 这个是spring.data的标准，在真正执行查询时还要把如IS CONTAINS 这样的方法转换成LUCENE的语法
// * 从这个角度来讲，SEARCHQUERY更贴合过原生的LUCENE语法
// * 
// * 
...
//        return "Criteria{" + "field=" + field.getName() + ", boost=" + boost + ", negating=" + negating + ", queryCriteria=" + StringUtils.join(queryCriteria, '|') + ", filterCriteria=" + StringUtils.join(filterCriteria, '|') + '}';
//    }
//
...
//        Preconditions.checkNotNull(field, "Field for criteria must not be null");
//        Preconditions.checkState(SpringStringUtils.hasText(field.getName()), "Field.name for criteria must not be null/empty");
...
//        Preconditions.checkNotNull(criteriaChain, "CriteriaChain must not be null");
//        Preconditions.checkNotNull(field, "Field for criteria must not be null");
//        Preconditions.checkState(SpringStringUtils.hasText(field.getName()), "Field.name for criteria must not be null/empty");
//
...
//        Preconditions.checkNotNull(criteria, "Cannot chain 'null' criteria.");
//
...
//     * EG:"query" : "*垌镇*" 匹配后的结果是只要有部分匹配就可以，而不是想要的包"垌镇"的
//     * @param s
//     * @return
//     */
...
//        Preconditions.checkNotNull(values, "Collection of 'in' values must not be null");
...
//        Preconditions.checkNotNull(values, "Collection of 'NotIn' values must not be null");
...
//     *
//     * @param location
//     *            {@link lemon.elastic.query4j.esproxy.core.geo.GeoPoint}
//     *            center coordinates
//     * @param distance
//     *            {@link String} radius as a string (e.g. : '100km'). Distance
//     *            unit : either mi/miles or km can be set
//     * @return Criteria the chaind criteria with the new 'within' criteria
//     *         included.
//     */
//    public Criteria within(GeoPoint location, String distance) {
//        Preconditions.checkNotNull(location, "Location value for near criteria must not be null");
//        Preconditions.checkNotNull(location, "Distance value for near criteria must not be null");
...
//     *
//     * @param location
//     *            {@link lemon.elastic.query4j.esproxy.geo.Point} center coordinates
//     * @param distance
//     *            {@link lemon.elastic.query4j.esproxy.geo.Distance} radius .
//     * @return Criteria the chaind criteria with the new 'within' criteria
//     *         included.
//     */
...
//     *
//     * @param geoLocation
//     *            {@link String} center point supported formats: lat on = >
...
//        Preconditions.checkState(StringUtils.isNotBlank(geoLocation), "geoLocation value must not be null");
...
//     *
//     * @param boundingBox
//     *            {@link lemon.elastic.query4j.esproxy.core.geo.GeoBox}
//     *            bounding box(left top corner + right bottom corner)
//     * @return Criteria the chaind criteria with the new 'boundingBox' criteria
//     *         included.
//     */
//    public Criteria boundedBy(GeoBox boundingBox) {
//        Preconditions.checkNotNull(boundingBox, "boundingBox value for boundedBy criteria must not be null");
...
//     *
//     * @param topLeftGeohash
//     *            left top corner of bounding box as geohash
//     * @param bottomRightGeohash
//     *            right bottom corner of bounding box as geohash
...
//        Preconditions.checkState(StringUtils.isNotBlank(topLeftGeohash), "topLeftGeohash must not be empty");
//        Preconditions.checkState(StringUtils.isNotBlank(bottomRightGeohash), "bottomRightGeohash must not be empty");
...
//     *            right bottom corner of bounding box
//     * @return Criteria the chaind criteria with the new 'boundedBy' criteria
//     *         included.
//     */
//    public Criteria boundedBy(GeoPoint topLeftPoint, GeoPoint bottomRightPoint) {
//        Preconditions.checkNotNull(topLeftPoint, "topLeftPoint must not be null");
//        Preconditions.checkNotNull(bottomRightPoint, "bottomRightPoint must not be null");
