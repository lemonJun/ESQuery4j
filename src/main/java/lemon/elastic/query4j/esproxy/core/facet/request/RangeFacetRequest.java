...
public class RangeFacetRequest extends AbstractFacetRequest {
    ...
    public FacetBuilder getFacet() {
        ...
        Preconditions.checkState(StringUtils.isNotBlank(field) || StringUtils.isNotBlank(keyField) && StringUtils.isNotBlank(valueField), "Please select field or key field and value field !!!");
