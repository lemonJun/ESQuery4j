 ...
 */
package lemon.elastic.query4j.esproxy.core.facet.result;

import java.util.List;

import lemon.elastic.query4j.esproxy.core.facet.AbstractFacetResult;
import lemon.elastic.query4j.esproxy.core.facet.FacetType;
