 ...
 */
package lemon.elastic.query4j.esproxy.core.facet;
...
public class AbstractFacetResult implements FacetResult {
    ...
    protected AbstractFacetResult(String name, FacetType type) {
        Preconditions.checkState(SpringStringUtils.hasText(name), "Facet name can't be null and should have a value");
        this.name = name;
        this.type = type;
    }
