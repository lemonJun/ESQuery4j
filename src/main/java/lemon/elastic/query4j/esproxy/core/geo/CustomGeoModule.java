...
public class CustomGeoModule extends SimpleModule {
    ...
    /**
     * Creates a new {@link lemon.elastic.query4j.esproxy.core.geo.CustomGeoModule} registering serializers and deserializers for spring data commons geo-spatial types.
     */
