...
import lemon.elastic.query4j.esproxy.domain.Range;
...
public class Distance implements Serializable, Comparable<Distance> {
    ...
    public Distance add(Distance other) {
        ...
        Preconditions.checkNotNull(other, "Distance to add must not be null!");
    ...
    public Distance add(Distance other, Metric metric) {
        ...
        Preconditions.checkNotNull(other, "Distance to must not be null!");
        Preconditions.checkNotNull(metric, "Result metric must not be null!");
