...
/**
 * Value object to capture {@link GeoResult}s as well as the average distance
 * they have.
 * 
...
public class GeoResults<T> implements Iterable<GeoResult<T>>, Serializable {
    ...
    /**
     * Creates a new {@link GeoResults} instance manually calculating the
     * average distance from the distance values of the given {@link GeoResult}
     * s.
     * 
     * @param results
    ...
    /**
     * Creates a new {@link GeoResults} instance manually calculating the
     * average distance in the given {@link Metric} from the distance values of
     * the given {@link GeoResult}s.
     * 
     * @param results
     *        must not be {@literal null}.
     * @param metric
    ...
    /**
     * Creates a new {@link GeoResults} instance from the given
     * {@link GeoResult}s and average distance.
     * 
     * @param results
     *        must not be {@literal null}.
    ...
    public String toString() {
        return String.format("GeoResults: [averageDistance: %s, results: %s]", averageDistance.toString(), SpringStringUtils.collectionToCommaDelimitedString(results));
    }
