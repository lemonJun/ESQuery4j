...
public class Circle implements Shape {
     ...
     * @param radius
     *        must not be {@literal null} and it's value greater or equal to
     *        zero.
     */
    public Circle(Point center, Distance radius) {

        Preconditions.checkNotNull(center);
        Preconditions.checkNotNull(radius);
        Preconditions.checkState(radius.getValue() >= 0, "Radius must not be negative!");
